    ...
    <div className="min-h-screen bg-(--dr-neutral) text-foreground">
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-10 sm:px-6 lg:px-8">
        <header className="mb-6">
          ...
          {notice ? (
            <p className="mt-3 rounded-2xl bg-(--dr-neutral) px-3 py-2 text-xs text-foreground">
              {notice}
            </p>
          ) : null}
        </header>
        ...
        <main className="rounded-3xl border border-[#e0e0e0] bg-white p-5 shadow-sm">
          ...
          >
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full rounded-2xl border border-[#e0e0e0] bg-(--dr-neutral) px-3 py-2 text-sm text-foreground placeholder:text-[#bdbdbd] focus:border-(--dr-primary) focus:outline-none"
            ...
            <button
              type="submit"
              className="mt-2 inline-flex w-full items-center justify-center rounded-full bg-(--dr-primary) px-4 py-2.5 text-xs font-semibold uppercase tracking-[0.18em] text-white shadow-sm shadow-(--dr-primary)/50 hover:bg-(--dr-accent)"
            >
              Create account
            </button>
          </form>
          ...
          <div className="mt-4 space-y-2 text-xs text-[#616161]">
            <p>
              ...
              <Link
                href="/login"
                className="font-semibold text-(--dr-primary) hover:underline"
              >
                Sign in
              </Link>
              .
            ...
            <p>
              <Link
                href="/"
                className="text-[#757575] hover:text-(--dr-primary)"
              >
