export default function VendorProfileManagePage() {
  return (
    <div className="min-h-screen bg-[var(--dr-neutral)] text-[var(--dr-text)]">
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-4 pb-10 pt-6 sm:px-6 lg:px-8">
        ...
        <main className="grid gap-5 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1.1fr)]">
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <p className="text-[11px] text-[#9e9e9e]">
                Changes are for demo only and are not persisted yet.
              </p>
            </div>
          </section>
        </main>
